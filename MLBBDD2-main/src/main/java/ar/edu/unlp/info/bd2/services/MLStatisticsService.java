...
public interface MLStatisticsService {
	...
	/**
	 * @param amount
	 * @return una lista de los usuarios que han gastando más de <code>amount</code> entre todas sus compras en la plataforma
	 */
	...
	/**
     * @return el producto con más demanda independientemente del proveedor que lo venda 
     */
    Product getBestSellingProduct();
    
    /**
     * @return una lista de productos que no cambiaron su precio independientemente del proveedor que lo venda
     */
    List<Product> getProductsOnePrice();
    
    /**
     * @return una lista de productos cuya diferencia de precio entre el proveedor más barato y el más caro es superior al 20%
     */
    List <Product> getProductWithMoreThan20percentDiferenceInPrice();
    
    /**
     * @return el proveedor con el producto de menor valor de los ofrecidos actualmente en la plataforma
     */
    Provider getProviderLessExpensiveProduct();
    
    /**
     * @param day
     * @return una lista de proveedores que no vendieron productos en un <code>day</code>
     */
    ...
    /**
     * @return la lista de productos que no se han vendido independientemente del proveedor que los ofrece
     */
